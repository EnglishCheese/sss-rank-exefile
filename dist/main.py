...
img_back = "a667b04d1c9c43233ab13f7a404b5b02.jpg."#фон
img_hero = "images__1_-removebg-preview.png."#персонаж
img_bullet = 'bullet.png'
img_enemy = 'png-transparent-real-impact-games-video-game-privacy-policy-money-asteroid-impact-removebg-preview.png'
score = 0
lost = 0
max_lost = 3
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(50, win_width-80), -60,
                    80, 50, randint(1, 5)) #швидкість ворог
    monsters.add(monster)


mixer.init()
mixer.music.load("space.ogg") #фон музика
mixer.music.play()
...
win = font1.render('You win?!', True, (255, 255, 255)) #колір
...
while run:
    ...
    if not finish:
        ...
        collides = sprite.groupcollide(monsters, bullets, True,
                                       True)
        for c in collides:
            score += 1
